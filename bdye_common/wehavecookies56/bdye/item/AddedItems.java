package wehavecookies56.bdye.item;
...
public class AddedItems {
    ...
    public static Item YelloweDye;
    public static Item LimeDye;
    public static Item PinkDye;
    public static Item GreyDye;
    public static Item LightGreyDye;
    ...
    public static void initItems(){
        WhiteDye = new ItemWhite(IDs.WHITE_DYE);
    }
}
